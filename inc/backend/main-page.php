...
<header class="rss-title">
	<H1><?php esc_html_e('Rigororus Social Share','RSS_TEXTDOMAIN');?></H1>
</header>
		...
		<form method="post" action="<?php echo admin_url() .'/admin-post.php'?>">
			...
			<div class="rss_share_option">
				...
				<div class="rss-social-input">
					<ul>
						<li>				
							<input type="checkbox" id="rss_facebook" name="rss_facebook" value="facebook" <?php echo ( $rss_settings['rss_facebook'] == 'facebook' ? 'checked' : 'checked' ) ; ?>>
							<i class="fa fa-facebook"></i><?php esc_html_e('Facebook','RSS_TEXTDOMAIN');?>
						</li>
						<li>
							<input type="checkbox" id="rss_twitter"  name="rss_twitter" value="twitter" <?php echo ( $rss_settings['rss_twitter'] == 'twitter' ? 'checked' : 'checked' ) ; ?>>
							<i class="fa fa-twitter"></i><?php esc_html_e('Twitter','RSS_TEXTDOMAIN');?>
						</li>	
						<li>
							<input type="checkbox" id="rss_pinterest" name="rss_pinterest" value="pinterest" <?php echo ( $rss_settings['rss_pinterest'] == 'pinterest' ? 'checked' : 'checked' ) ; ?>>
							<i class="fa fa-pinterest"></i><?php esc_html_e('Pinterest','RSS_TEXTDOMAIN');?>
						</li>	
						<li>
							<input type="checkbox" id="rss_linkedin" name="rss_linkedin" value="linkedin" <?php echo ( $rss_settings['rss_linkedin'] == 'linkedin' ? 'checked' : 'checked' ) ; ?>>
							<i class="fa fa-linkedin"></i><?php esc_html_e('Linkedin','RSS_TEXTDOMAIN');?>
						</li>	
						<li>
							<input type="checkbox" id="rss_googlePlus" name="rss_googlePlus" value="googleplus" <?php echo ( $rss_settings['rss_googlePlus'] == 'googleplus' ? 'checked' : 'checked' ) ; ?>>
				...
				<div class="rss_display_option">
					...
					<div class="rss-display-option">
						<ul>
							...
							<li>
								<input type="checkbox" name="rss_after_post" id = "rss_after_post" value="after_post" <?php echo ( $rss_settings['rss_after_post'] == 'after_post' ? 'checked' : 'checked' ) ; ?>>
								<?php esc_html_e( 'Show After Post', 'rigorousweb-social-media' ); ?>
							</li>
							<li>
								<input type="checkbox" name="rss_after_page" id = "rss_after_page" value="after_page" <?php echo ( $rss_settings['rss_after_page'] == 'after_page' ? 'checked' : 'checked' ) ; ?>>
